...
import NavSidebar from '../NavSidebar'; // Importar el nuevo componente
...
const Header = ({ onUploadPropertyClick, onEditPropertyClick, onContactClick, onHomeClick, onShowChangeProfilePicture }) => {
    ...
    const [isNavSidebarOpen, setIsNavSidebarOpen] = useState(false); // Estado para la barra lateral
    ...
    return (
        <>
            <header className="header-glassmorphism">
                <button className="hamburger-menu" onClick={() => setIsNavSidebarOpen(true)}>
                    <span>☰</span>
                </button>
